...
<table width = '100%' border = '1' id = 'besar'>
	...
	<tr>
	<!-- bahagian borang mendaftar set soalan yang baharu -->
...
|<a href = 'set_kemaskini.php?".http_build_query($data_get)."'>Kemaskini</a>

|<a href = 'padam.php?jadual=set_soalan&medan=no_set&id=".$data['no_set']."'onClick=\"return confirm ('Anda pasti ingin memadam data ini?')\">Padam</a>
			</td>
	 	</tr>";
}
?>	
